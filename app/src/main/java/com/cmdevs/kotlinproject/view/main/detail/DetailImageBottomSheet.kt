package com.cmdevs.kotlinproject.view.main.detail
...
import com.cmdevs.kotlinproject.view.main.detail.presenter.DetailImageContract
import com.cmdevs.kotlinproject.view.main.detail.presenter.DetailImagePresenter
...
class DetailImageBottomSheet : BottomSheetDialogFragment(), DetailImageContract.View {
    ...
    private val detailImagePresenter: DetailImagePresenter by lazy {
        DetailImagePresenter(this@DetailImageBottomSheet, FlickerRepository)
    }
    ...
    ): View? = View.inflate(context, R.layout.layout_photo_detail, null)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        img_web.setOnClickListener {
            detailImagePresenter.loadFlickerWebPage()
        }

        detailImagePresenter.loadDetailInfo(arguments?.getString(KEY_PHOTO_ID).toString())
    }

    override fun showFlickerWebPage(url: String) {
